export default () => ({
  ...
  whatsapp: {
    provider: process.env.WHATSAPP_PROVIDER || "", // 'twilio' | 'msg91' | ...
    twilio: {
      accountSid: process.env.TWILIO_ACCOUNT_SID,
      authToken: process.env.TWILIO_AUTH_TOKEN,
      from: process.env.TWILIO_WHATSAPP_FROM, // e.g., +14155238886 (Twilio WA sandbox or approved number)
    },
    msg91: {
      templateId: process.env.MSG91_WA_TEMPLATE_ID, // your approved WA template id
    },
  },
  newRelic: {
  ...
  analytics: {
    gtmServerUrl: process.env.GTM_SERVER_CONTAINER_URL, // e.g., https://gtm.example.com
